...
<section class="hero">
  ...
  <div class="hero-text white text-center">
    ...
    <p class="light-grey mb-l">
      I moved to Spain seven years ago. The process was painful and difficult. I learned most things the hard way: finding a job, getting a visa, calculating my cost of living, choosing an apartment. That's why I wrote this e-book--to tell you how I did it. No bull, no stress.
    </p>
